...
st.subheader("""Last **closing price** for """ + "TSLA")
...
st.subheader("""Daily **volume** for """ + "TSLA")
...
if actions:
    st.subheader("""Stock **actions** for """ + "TSLA")
...
if financials:
    st.subheader("""**Quarterly financials** for """ + "TSLA")
...
if major_shareholders:
    st.subheader("""**Institutional investors** for """ + "TSLA")
...
if balance_sheet:
    st.subheader("""**Quarterly balance sheet** for """ + "TSLA")
...
if cashflow:
    st.subheader("""**Quarterly cashflow** for """ + "TSLA")
...
if earnings:
    st.subheader("""**Quarterly earnings** for """ + "TSLA")
...
if analyst_recommendation:
    st.subheader("""**Analysts recommendation** for """ + "TSLA")
