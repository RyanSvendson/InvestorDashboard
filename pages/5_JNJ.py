...
#main function
st.write("# Information on Johnson & Johnson")
st.subheader("""Daily **closing price** for """ + "JNJ")
#get data on searched ticker
stock_data = yf.Ticker("JNJ")
#get historical data for searched ticker
stock_df = stock_data.history(period='1d', start='2020-01-01', end=None)
#print line chart with daily closing prices for searched ticker
st.line_chart(stock_df.Close)

st.subheader("""Last **closing price** for """ + "JNJ")
...
st.subheader("""Daily **volume** for """ + "JNJ")
...
if actions:
    st.subheader("""Stock **actions** for """ + "JNJ")
...
if financials:
    st.subheader("""**Quarterly financials** for """ + "JNJ")
...
if major_shareholders:
    st.subheader("""**Institutional investors** for """ + "JNJ")
...
if balance_sheet:
    st.subheader("""**Quarterly balance sheet** for """ + "JNJ")
...
if cashflow:
    st.subheader("""**Quarterly cashflow** for """ + "JNJ")
...
if earnings:
    st.subheader("""**Quarterly earnings** for """ + "JNJ")
...
if analyst_recommendation:
    st.subheader("""**Analysts recommendation** for """ + "JNJ")
