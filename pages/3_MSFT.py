...
#main function
st.write("# Information on Microsoft")
st.subheader("""Daily **closing price** for """ + "MSFT")
...
st.subheader("""Last **closing price** for """ + "MSFT")
...
st.subheader("""Daily **volume** for """ + "MSFT")
...
if actions:
    st.subheader("""Stock **actions** for """ + "MSFT")
...
if financials:
    st.subheader("""**Quarterly financials** for """ + "MSFT")
...
if major_shareholders:
    st.subheader("""**Institutional investors** for """ + "MSFT")
...
if balance_sheet:
    st.subheader("""**Quarterly balance sheet** for """ + "MSFT")
...
if cashflow:
    st.subheader("""**Quarterly cashflow** for """ + "MSFT")
...
if earnings:
    st.subheader("""**Quarterly earnings** for """ + "MSFT")
...
if analyst_recommendation:
    st.subheader("""**Analysts recommendation** for """ + "MSFT")
